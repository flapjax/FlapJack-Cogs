...
class Spoiler(BaseCog):
    ...
    async def spoiler(self, ctx, title: str, spoiler: str=None, *, overflow: str=None):
        ...
        if overflow:
            # Assume user meant entire text to be spoiler
            spoiler = title + " " + spoiler + " " + overflow
            title = ""
        elif spoiler is None:
